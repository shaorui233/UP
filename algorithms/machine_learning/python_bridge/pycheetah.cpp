...
/*-----------------------------------------------
              @(target):= _pycheetah.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__pycheetah

#else
#  define SWIG_init    init_pycheetah

#endif
#define SWIG_name    "_pycheetah"
...
SWIGINTERN PyObject *_wrap_step(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "step", 5, 5, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_double, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  if (!SWIG_IsOK(ecode5)) {
    SWIG_exception_fail(SWIG_ArgError(ecode5), "in method '" "step" "', argument " "5"" of type '" "bool""'");
  } 
  arg5 = static_cast< bool >(val5);
  result = (int)step(arg1,arg2,arg3,arg4,arg5);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "doubleArray_swigregister", doubleArray_swigregister, METH_VARARGS, NULL},
	 { "doubleArray_swiginit", doubleArray_swiginit, METH_VARARGS, NULL},
	 { "step", _wrap_step, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
