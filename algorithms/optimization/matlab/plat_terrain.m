...
%% 
fn_path = '/home/dhkim/Repository/Cheetah-Software/optimization/matlab/functions';

addpath(fn_path)

data_path = '/home/dhkim/Repository/Cheetah-Software/optimization/optimization_data/2019-03-05-00_00_03';
iter = 1;
...
body_ori = fn_read_file(data_path, ori_file, 1);
...
for i = 1:size(foot_loc, 2)
    ...
    rot_yaw = [cos(yaw), -sin(yaw), 0;
        sin(yaw), cos(yaw), 0;
        0, 0, 1];
    body_fr = rot_yaw * rot_pitch * fr + body_pos(:, 40*i+1);
    body_fl = rot_yaw * rot_pitch * fl + body_pos(:, 40*i+1);
    body_hr = rot_yaw * rot_pitch * hr + body_pos(:, 40*i+1);
    body_hl = rot_yaw * rot_pitch * hl + body_pos(:, 40*i+1);
    % body rectangle
    plot3([body_fr(1), body_fl(1)], [body_fr(2), body_fl(2)],[body_fr(3), body_fl(3)], 'linewidth',1, 'color',color_list{j});
    plot3([body_fl(1), body_hl(1)], [body_fl(2), body_hl(2)],[body_fl(3), body_hl(3)], 'linewidth',1, 'color',color_list{j});
    plot3([body_hl(1), body_hr(1)], [body_hl(2), body_hr(2)],[body_hl(3), body_hr(3)], 'linewidth',1, 'color',color_list{j});
    plot3([body_hr(1), body_fr(1)], [body_hr(2), body_fr(2)],[body_hr(3), body_fr(3)], 'linewidth',1, 'color',color_list{j});
    ...
    % FR
    plot3([body_fr(1), foot_loc(1,i)], [body_fr(2), foot_loc(2,i)], [body_fr(3), foot_loc(3,i)], 'color', color_list{j});
    ...
    % FL
    plot3([body_fl(1), foot_loc(4,i)], [body_fl(2), foot_loc(5,i)], [body_fl(3), foot_loc(6,i)], 'color', color_list{j});
    ...
    % HR
    plot3([body_hr(1), foot_loc(7,i)], [body_hr(2), foot_loc(8,i)], [body_hr(3), foot_loc(9,i)], 'color', color_list{j});
    ...
    % HL
    plot3([body_hl(1), foot_loc(10,i)], [body_hl(2), foot_loc(11,i)], [body_hl(3), foot_loc(12,i)], 'color', color_list{j});
