...
void balanceControl_set_desiredTrajectoryData(double* rpy_des_in, double* p_des_in, double* omegab_des_in, double* v_des_in)//, double* vdot_des_in)
{
  BalanceControllerObj->set_desiredTrajectoryData(rpy_des_in, p_des_in, omegab_des_in, v_des_in);//, vdot_des_in );
}
...
void balanceControl_set_PDgains(double* Kp_COM_in, double* Kd_COM_in, double* Kp_Base_in, double* Kd_Base_in)
{
  BalanceControllerObj->set_PDgains(Kp_COM_in, Kd_COM_in, Kp_Base_in, Kd_Base_in);
}

void balanceControl_set_wrench_weights(double* COM_weights_in, double* Base_weights_in)
{
...
void balanceControl_updateProblemData(double* xfb_in, double* pFeet_in, double yaw_in)
{
  ...
  BalanceControllerObj->updateProblemData( xfb_in,
      pFeet_in,
      p_des,
      p_act,
      v_des,
...
void bcPrint()
{
  printf("balance controller here\n\n");
}
