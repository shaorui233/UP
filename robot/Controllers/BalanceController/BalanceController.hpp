...
#include "controllerlcm/qp_controller_data_t.hpp"
...
class BalanceController
{
   public:
      ...
      void set_desiredTrajectoryData(double* rpy_des_in, double* p_des_in, double* omegab_des_in, double* v_des_in, double* vdot_des_in);
   ...
   private:
      lcm::LCM * lcm;
      controllerlcm::qp_controller_data_t qp_controller_data, qp_controller_data_publish;      
      cheetahlcm::sim_command_t command;
