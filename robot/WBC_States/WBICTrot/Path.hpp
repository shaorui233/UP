    ...
    public:
        ...
        virtual void getDesLoc(
            ...
            if (path_time < _prepare_time){
                ...
                _target_loc[0] = _ini_loc[0] + 
                    _amp * sin(2.*M_PI*_freq * (path_time-_prepare_time) );
            }
            des_loc = _target_loc;
        }
    ...
    public:
        ...
        virtual void getDesLoc(
            ...
            if (path_time < _prepare_time){
                ...
                _target_loc[0] = _ini_loc[0] + 
                    _radius_x * sin(2.*M_PI*_freq * 
                            (path_time-_prepare_time) );
                _target_loc[1] = _ini_loc[1] + 
                    _radius_y * (cos(2.*M_PI*_freq * 
                                (path_time-_prepare_time) ) - 1.);
