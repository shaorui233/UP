...
void unpack_sbus_data(uint8_t sbus_data[], uint16_t *channels) {
  if ((sbus_data[0] == 0xF) && (sbus_data[24] == 0x0)) {
    ...
    channels[2] = ((sbus_data[3] & 0xC0) >> 6) | (sbus_data[4] << 2) | ((sbus_data[5] & 0x1) << 10);
    channels[3] = ((sbus_data[5] & 0xFE) >> 1) | ((sbus_data[6] & 0xF) << 7);
    channels[4] = ((sbus_data[6] & 0xF0) >> 4) | ((sbus_data[7] & 0x7F) << 4);
    channels[5] = ((sbus_data[7] & 0x80) >> 7) | (sbus_data[8] << 1) | ((sbus_data[9] & 0x3) << 9);
    channels[6] = ((sbus_data[9] & 0xFC) >> 2) | ((sbus_data[10] & 0x1F) << 6);
    channels[7] = ((sbus_data[10] & 0xE0) >> 5) | (sbus_data[11] << 3);

    channels[8] = ((sbus_data[12]) | ((sbus_data[13] & 0x7) << 8));
    channels[9] = (sbus_data[13] >> 3) | ((sbus_data[14] & 0x3F) << 5);
    channels[10] = ((sbus_data[14] & 0xC0) >> 6) | (sbus_data[15] << 2) | ((sbus_data[16] & 0x1) << 10);
    channels[11] = ((sbus_data[16] & 0xFE) >> 1) | ((sbus_data[17] & 0xF) << 7);
    channels[12] = ((sbus_data[17] & 0xF0) >> 4) | ((sbus_data[18] & 0x7F) << 4);
    channels[13] = ((sbus_data[18] & 0x80) >> 7) | (sbus_data[19] << 1) | ((sbus_data[20] & 0x3) << 9);
    channels[14] = ((sbus_data[20] & 0xFC) >> 2) | ((sbus_data[21] & 0x1F) << 6);
    channels[15] = ((sbus_data[21] & 0xE0) >> 5) | (sbus_data[22] << 3);
