...
class ReferenceGRF
{
   public:
      ...
      void SetContactData(double* contact_state_in,double* min_forces_in,double* max_forces_in); // new
   ...
   private:
      ...
      real_t    A_qpOASES[NUM_CONSTRAINTS_QP_DES*NUM_VARIABLES_QP_DES];
      real_t    g_qpOASES[NUM_VARIABLES_QP_DES];
      real_t   lb_qpOASES[NUM_VARIABLES_QP_DES];
      real_t   ub_qpOASES[NUM_VARIABLES_QP_DES];
      real_t  lbA_qpOASES[NUM_CONSTRAINTS_QP_DES];
      real_t  ubA_qpOASES[NUM_CONSTRAINTS_QP_DES];  
