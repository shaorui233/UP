...
void Jump2DLagrangianHessian(const double in1[6], const double in2[4], double
  obj_factor, double lagrangian_hessian_nz[10])
{
  /* JUMP2DLAGRANGIANHESSIAN */
  /*     LAGRANGIAN_HESSIAN_NZ = JUMP2DLAGRANGIANHESSIAN(IN1,IN2,OBJ_FACTOR) */
  /*     This function was generated by the Symbolic Math Toolbox version 8.0. */
  /*     27-Aug-2019 12:38:34 */
  lagrangian_hessian_nz[0] = obj_factor * in1[0] * 2.0;
  lagrangian_hessian_nz[1] = obj_factor * in1[1] * 2.0;
  lagrangian_hessian_nz[2] = obj_factor * in1[2] * 2.0;
  lagrangian_hessian_nz[3] = obj_factor * in1[3] * 2.0;
  lagrangian_hessian_nz[4] = obj_factor * in1[4] * 2.0;
  lagrangian_hessian_nz[5] = obj_factor * in1[5] * 2.0;
  lagrangian_hessian_nz[6] = obj_factor * in2[0] * 2.0;
  lagrangian_hessian_nz[7] = obj_factor * in2[1] * 2.0;
  lagrangian_hessian_nz[8] = obj_factor * in2[2] * 2.0;
  lagrangian_hessian_nz[9] = obj_factor * in2[3] * 2.0;
}

/* End of code generation (Jump2DLagrangianHessian.cpp) */
