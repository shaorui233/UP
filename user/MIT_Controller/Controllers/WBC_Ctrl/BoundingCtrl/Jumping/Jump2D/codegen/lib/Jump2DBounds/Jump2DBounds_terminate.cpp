 ...
 *
 * Jump2DBounds_terminate.cpp
 *
 * Code generation for function 'Jump2DBounds_terminate'
 *
 */
...
void Jump2DBounds_terminate()
{
  /* (no terminate code required) */
}

/* End of code generation (Jump2DBounds_terminate.cpp) */
