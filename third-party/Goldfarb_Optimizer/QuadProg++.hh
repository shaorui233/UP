...
template<typename T>
void print_matrix(const std::string & name, const GMatr<T>& A, int n = -1, int m = -1);
...
template<typename T>
inline T scalar_product(const GVect<T>& x, const GVect<T>& y)
{
...
template<typename T>
inline void compute_d(GVect<T>& d, const GMatr<T>& J, const GVect<T>& np)
{
...
template<typename T>
inline void update_z(GVect<T>& z, const GMatr<T>& J, const GVect<T>& d, int iq)
{
...
template<typename T>
inline void update_r(const GMatr<T>& R, GVect<T>& r, const GVect<T>& d, int iq)
{
  register int i, j, n = d.size();
  (void)n;
  register T sum;
...
template<typename T>
bool add_constraint(GMatr<T>& R, GMatr<T>& J, GVect<T>& d, int& iq, T& R_norm)
{
  int n = d.size();
#ifdef TRACE_SOLVER
...
template<typename T>
void delete_constraint(GMatr<T>& R, GMatr<T>& J, GVect<int>& A, GVect<T>& u, 
        int n, int p, int& iq, int l)
{
#ifdef TRACE_SOLVER
...
template<typename T>
void cholesky_decomposition(GMatr<T>& A)
{
...
template<typename T>
inline void forward_elimination(const GMatr<T>& L, GVect<T>& y, const GVect<T>& b)
{
...
template<typename T>
inline void backward_elimination(const GMatr<T>& U, GVect<T>& x, const GVect<T>& y)
{
...
template<typename T>
void cholesky_solve(const GMatr<T>& L, GVect<T>& x, const GVect<T>& b)
{
  int n = L.nrows();
  GVect<T> y(n);
...
// Udouble>& d, const GMatr<T>& J, const GVect<T>& np);

//template<typename T>
//void update_z(GVect<T>& z, const GMatr<T>& J, const GVect<T>& d, int iq);

//template<typename T>
//void update_r(const GMatr<T>& R, GVect<T>& r, const GVect<T>& d, int iq);

//template<typename T>
//bool add_constraint(GMatr<T>& R, GMatr<T>& J, GVect<T>& d, int& iq, T& rnorm);

//template<typename T>
//void delete_constraint(GMatr<T>& R, GMatr<T>& J, GVect<int>& A, GVect<T>& u, int n, int p, int& iq, int l);
...
//template<typename T>
//T scalar_product(const GVect<T>& x, const GVect<T>& y);
//template<typename T>
//T distance(T a, T b);

// The Solving function, implementing the Goldfarb-Idnani method
template<typename T>
T solve_quadprog(GMatr<T>& G, GVect<T>& g0,
                      const GMatr<T>& CE, const GVect<T>& ce0,
                      const GMatr<T>& CI, const GVect<T>& ci0,
                      GVect<T>& x)
{
  ...
  GMatr<T> R(n, n), J(n, n);
  GVect<T> s(m + p), z(n), r(m + p), d(n), np(n), u(m + p), x_old(n), u_old(m + p);
...
template<typename T>
void print_matrix(const std::string & name, const GMatr<T>& A, int n, int m)
{
  std::ostringstream s;
  std::string t;
  if (n == -1)
