...
FootLocPreference::FootLocPreference():WalkingForward()
{
...
FootLocPreference::~FootLocPreference(){}

double FootLocPreference::ObjectiveFn(
    ...
    FootLocPreference* tester = (FootLocPreference*)d_;
    double cost_leg(0.);
...
bool FootLocPreference::SolveOptimization(){
    // Reset Problem
    ...
    test->set_min_objective(FootLocPreference::ObjectiveFn, this);
