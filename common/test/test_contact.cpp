...
TEST(Contact, normalContact) {
  ...
  pMATLAB << 0, 1.0000, 2.0000, 3.0000, 4.0000, 5.0000, 6.0000, 7.0000, 8.0000,
      9.0000, 9.0000, 8.0000, 7.0000, 6.0000, 5.0000, 4.0000, 3.0000, 2.0000,
      1.0000, 45.0000, 0.1000, -0.1000, -0.0200, -0.0300, 0.0400, -1.0000,
      -2.0000, -0.0001, -0.1000, -0.2000;

  pdMATLAB << 1.0000, 2.0000, 3.0000, 4.0000, 5.0000, 6.0000, 7.0000, 8.0000,
      9.0000, 10.0000, -1.0000, -2.0000, -4.0000, -2.0000, 3.0000, 2.0000,
      1.0000, 2.0000, 5.0000, 3.0000, -0.0010, -2.0000, -1.0000, 2.0000,
      -1.0000, -0.0010, 0.0020, 0.0200, -0.1000, 0.3000;

  uMATLAB << 0, 0, 0, 0, 0.2000, 0.2000, 0.3000, 0.4000, 0.5000, 0.2000,
      -0.2000, 0, 0, 0, -0.3000, 0.3000, 0.1000, 0.3000, 0.2000, 0;

  fMATLAB << 0, -15.8114, -10.6066, 0, 0, -68.0631, -201.0705, 0, -6.1473, 0, 0,
      15.8114, 14.1421, 0, 0, -23.9382, -29.4963, 0, -3.3903, 0, 0, 16.1909,
      3.5695, 0, 0, 12.0250, 33.8704, 0, 1.1700, 0;

  uOutMATLAB << 0, 2.0000, 3.0000, 0, 0.1040, 2.8265, 5.8431, 0.2080, 1.0376,
      0.1040, -0.1040, -2.0000, -4.0000, 0, -0.1560, 1.1135, 0.8863, 0.1560,
      0.5328, 0;
...
TEST(Contact, normalContactWithOffset) {
  ...
  pMATLAB << 0, 1.0000, 2.0000, 3.0000, 4.0000, 5.0000, 6.0000, 7.0000, 8.0000,
      9.0000, 9.0000, 8.0000, 7.0000, 6.0000, 5.0000, 4.0000, 3.0000, 2.0000,
      1.0000, 45.0000, 0.1000 - 1, -0.1000 - 1, -0.0200 - 1, -0.0300 - 1,
      0.0400 - 1, -1.0000 - 1, -2.0000 - 1, -0.0001 - 1, -0.1000 - 1,
      -0.2000 - 1;
  ...
  Mat6<double> X =
      createSXform(Mat3<double>::Identity(), Vec3<double>(0, 0, -1));
  groundContactModelWithOffset<double>(p, pd, u, f, 12, 25, 6, 1, X);
