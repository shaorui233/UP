...
TEST(SharedMemory, MemoryAndSemaphore) {
  ...
  // allow overwriting because the last run of the test could have left memory open
  ...
  oldStaleSharedMemory.get()->value = 12; // this shouldn't segfault if the memory is mapped succesfully
