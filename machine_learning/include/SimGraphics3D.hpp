...
#ifndef SIMPLE_GRAPHICS3D_H
#define SIMPLE_GRAPHICS3D_H
...
class SimGraphics3D: public QOpenGLWidget, protected QOpenGLFunctions {
Q_OBJECT
public:
  explicit SimGraphics3D(QWidget* parent = 0);
  virtual ~SimGraphics3D(){}
