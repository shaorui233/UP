...
#include "SimDrawList.hpp"

void SimDrawList::loadFiles() {
  printf("[SimDrawList] Load object files...\n");
  ...
  objLoader::SimObjectLoader loader;
 ...
 */
size_t SimDrawList::addCheetah3() {
 ...
 */
size_t SimDrawList::addMiniCheetah() {
 ...
 */
size_t SimDrawList::addCheckerboard(SimCheckerBoard& checkerBoard) {
  size_t j0 = _nTotal;
  size_t i0 = _nUnique;
 ...
 */
size_t SimDrawList::addDebugSphere(float radius) {
  assert(false);
  size_t j0 = _nTotal;
 ...
 */
void SimDrawList::buildSimDrawList() {
...
void SimDrawList::addBox(double depth, double width, double height, 
...
void SimDrawList::addMesh(double grid_size, const Vec3<double> & left_corner, 
